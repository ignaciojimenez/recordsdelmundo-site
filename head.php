...
<link href="<?php echo htmlspecialchars($root) ?>style/fonts.css" type="text/css" rel="stylesheet" />
<link href="<?php echo htmlspecialchars($root) ?>style/common.css" type="text/css" rel="stylesheet" />
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js" defer=true></script>
<script src="<?php echo htmlspecialchars($root) ?>scripts/main.js" defer=true></script>
